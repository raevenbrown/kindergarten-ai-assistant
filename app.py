...
# =========================================================
    ...
    # ROAD MAP CONTAINER WITH PRECISELY SNAPPED LEVEL BOXES
    road_map_html = f"""
    <div style="background:linear-gradient(135deg, #f0fdf4, #e0f2fe); border:6px solid #0284c7; border-radius:32px; padding:18px 15px 22px 15px; box-shadow:0 14px 28px rgba(0,0,0,0.12); position:relative; margin:10px auto; width:100%; box-sizing:border-box;">
        ...
        <svg width="100%" height="320" viewBox="0 0 1550 420" xmlns="http://www.w3.org/2000/svg" style="overflow:visible;">
            <!-- Perfectly centered winding road path -->
            <path d="M 40 280 Q 120 120 200 280 Q 280 440 360 280 Q 440 120 520 280 Q 600 440 680 280 Q 760 120 840 280 Q 920 440 1000 280 Q 1080 120 1160 280 Q 1240 440 1320 280 L 1400 280" fill="none" stroke="#64748b" stroke-width="13" stroke-linecap="round" opacity="0.6"/>
            <path d="M 40 280 Q 120 120 200 280 Q 280 440 360 280 Q 440 120 520 280 Q 600 440 680 280 Q 760 120 840 280 Q 920 440 1000 280 Q 1080 120 1160 280 Q 1240 440 1320 280 L 1400 280" fill="none" stroke="#cbd5e1" stroke-width="4.5" stroke-linecap="round" stroke-dasharray="9,9" opacity="0.8"/>

            <!-- LEVEL 1 (Valley - Bottom touching road at y=296) -->
            <g transform="translate(69, 296)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=1'">
            ...
            <!-- LEVEL 2 (Peak - Top touching road at y=130) -->
            ...
            <!-- LEVEL 3 (Valley - Bottom touching road at y=296) -->
            <g transform="translate(229, 296)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=3'">
            ...
            <!-- LEVEL 4 (Peak - Top touching road at y=130) -->
            ...
            <!-- LEVEL 5 (Valley - Bottom touching road at y=296) -->
            <g transform="translate(389, 296)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=5'">
            ...
            <!-- LEVEL 6 (Peak - Top touching road at y=130) -->
            ...
            <!-- LEVEL 7 (Valley - Bottom touching road at y=296) -->
            <g transform="translate(549, 296)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=7'">
            ...
            <!-- LEVEL 8 (Peak - Top touching road at y=130) -->
            ...
            <!-- LEVEL 9 (Valley - Bottom touching road at y=296) -->
            <g transform="translate(709, 296)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=9'">
            ...
            <!-- LEVEL 10 (Peak - Top touching road at y=130) -->
            ...
            <!-- LEVEL 11 (Valley - Bottom touching road at y=296) -->
            <g transform="translate(869, 296)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=11'">
            ...
            <!-- LEVEL 12 (Peak - Top touching road at y=130) -->
            ...
            <!-- LEVEL 13 (Valley - Bottom touching road at y=296) -->
            <g transform="translate(1029, 296)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=13'">
            ...
            <!-- LEVEL 14 (Peak - Top touching road at y=130) -->
            ...
            <!-- LEVEL 15 (Valley - Bottom touching road at y=296) -->
            <g transform="translate(1189, 296)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=15'">
            ...
            <!-- LEVEL 16 (Peak - Top touching road at y=130) -->
