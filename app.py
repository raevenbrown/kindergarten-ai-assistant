...
# =========================================================
# SCREEN 3: CANDY LAND ROAD MAP (LOWERED PADDING SO 100% CONTAINED INSIDE BLUE BORDER)
# =========================================================
    ...
    # FULL CONTAINER WITH BLUE BORDER, PADDED WITH 520px COMPONENT HEIGHT SO ALL NODES SIT COMFORTABLY INSIDE
    road_map_html = f"""
    <div style="background:linear-gradient(135deg, #e0f2fe, #bae6fd); border:5px solid #0284c7; border-radius:36px; padding:25px 20px 30px 20px; box-shadow:0 16px 32px rgba(0,0,0,0.12); position:relative; margin:10px auto; width:100%; box-sizing:border-box;">
        ...
        <!-- SVG VIEWBOX & HEIGHT ADJUSTED SO ALL NODES FIT SAFELY INSIDE WITH ROOM TO SPARE -->
        <svg width="100%" height="400" viewBox="0 0 1300 440" xmlns="http://www.w3.org/2000/svg" style="overflow:visible;">
            <!-- Winding Path Road -->
            <path d="M 60 300 Q 140 200 220 260 Q 300 320 380 180 Q 460 40 540 130 Q 620 220 700 80 Q 780 -60 860 40 Q 940 140 1020 -20 Q 1100 40 1180 -80" fill="none" stroke="#f43f5e" stroke-width="22" stroke-linecap="round" stroke-dasharray="16,12" opacity="0.85"/>

            <!-- LEVEL 1 -->
            <g transform="translate(40, 260)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=1'">
            ...
            <!-- LEVEL 2 -->
            <g transform="translate(130, 180)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=2'">
            ...
            <!-- LEVEL 3 -->
            <g transform="translate(220, 230)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=3'">
            ...
            <!-- LEVEL 4 (RAISED UP SO IT NEVER TOUCHES THE BOTTOM BORDER) -->
            <g transform="translate(310, 280)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=4'">
            ...
            <!-- LEVEL 5 -->
            <g transform="translate(400, 140)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=5'">
            ...
            <!-- LEVEL 6 -->
            <g transform="translate(480, 10)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=6'">
            ...
            <!-- LEVEL 7 -->
            <g transform="translate(560, 70)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=7'">
            ...
            <!-- LEVEL 8 -->
            <g transform="translate(640, 140)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=8'">
            ...
            <!-- LEVEL 9 -->
            <g transform="translate(710, 40)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=9'">
            ...
            <!-- LEVEL 10 -->
            <g transform="translate(770, -60)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=10'">
            ...
            <!-- LEVEL 11 -->
            <g transform="translate(840, -20)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=11'">
            ...
            <!-- LEVEL 12 -->
            <g transform="translate(910, 50)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=12'">
            ...
            <!-- LEVEL 13 -->
            <g transform="translate(980, 0)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=13'">
            ...
            <!-- LEVEL 14 -->
            <g transform="translate(1040, -50)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=14'">
            ...
            <!-- LEVEL 15 -->
            <g transform="translate(1100, -120)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=15'">
    ...
    """
    components.html(road_map_html, height=580)
