...
# =========================================================
# SCREEN 3: PERFECTLY CENTERED ROAD & FLUSH LEVEL BOXES
# =========================================================
    ...
    # PERFECTLY CENTERED ROAD & FLUSH LEVEL BOXES MATCHING YOUR DRAWING
    road_map_html = f"""
    <div style="background:linear-gradient(135deg, #f0fdf4, #e0f2fe); border:6px solid #0284c7; border-radius:32px; padding:18px 15px 22px 15px; box-shadow:0 14px 28px rgba(0,0,0,0.12); position:relative; margin:10px auto; width:100%; box-sizing:border-box;">
        ...
        <svg width="100%" height="320" viewBox="0 0 1550 420" xmlns="http://www.w3.org/2000/svg" style="overflow:visible;">
            ...
            <!-- LEVEL 1 (Valley - Bottom touching road) -->
            ...
            <!-- LEVEL 2 (Peak - Top touching road) -->
            ...
            <!-- LEVEL 3 (Valley - Bottom touching road) -->
            ...
            <!-- LEVEL 4 (Peak - Top touching road) -->
            ...
            <!-- LEVEL 5 (Valley - Bottom touching road) -->
            ...
            <!-- LEVEL 6 (Peak - Top touching road) -->
            ...
            <!-- LEVEL 7 (Valley - Bottom touching road) -->
            ...
            <!-- LEVEL 8 (Peak - Top touching road) -->
            ...
            <!-- LEVEL 9 (Valley - Bottom touching road) -->
            ...
            <!-- LEVEL 10 (Peak - Top touching road) -->
            ...
            <!-- LEVEL 11 (Valley - Bottom touching road) -->
            ...
            <!-- LEVEL 12 (Peak - Top touching road) -->
            ...
            <!-- LEVEL 13 (Valley - Bottom touching road) -->
            ...
            <!-- LEVEL 14 (Peak - Top touching road) -->
            ...
            <!-- LEVEL 15 (Valley - Bottom touching road) -->
            ...
            <!-- LEVEL 16 (Peak - Top touching road) -->
