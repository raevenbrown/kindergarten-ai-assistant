...
# =========================================================
# 3. CURRICULUM DEFINITION (16 COMPLETE LEVELS)
# =========================================================
...
CURRICULUM_LEVELS = [
    ...
    {"id": "lvl_14", "name": "Level 14: Personal Location & 50 U.S. States"},
    {"id": "lvl_15", "name": "Level 15: Spell Full Name (First, Middle, Last)"},
    {"id": "lvl_16", "name": "Level 16: Seasons, Days of the Week & Months"}
]
...
# =========================================================
# SCREEN 3: PERFECTLY FLUSH 16-LEVEL MAP
# =========================================================
    ...
    with col_lib:
        if st.button("📚 Library"):
            st.session_state.active_level_id = "lvl_16"
    ...
    # ROAD MAP CONTAINER WITH LEVEL BOXES PHYSICALLY SNAPPED DIRECTLY TO THE ROAD
    road_map_html = f"""
    <div style="background:linear-gradient(135deg, #f0fdf4, #e0f2fe); border:6px solid #0284c7; border-radius:32px; padding:18px 15px 22px 15px; box-shadow:0 14px 28px rgba(0,0,0,0.12); position:relative; margin:10px auto; width:100%; box-sizing:border-box;">
        ...
        <svg width="100%" height="320" viewBox="0 0 1550 420" xmlns="http://www.w3.org/2000/svg" style="overflow:visible;">
            <!-- Winding road path with peaks at y=184 and valleys at y=236 -->
            <path d="M 40 236 Q 120 184 200 236 Q 280 288 360 236 Q 440 184 520 236 Q 600 288 680 236 Q 760 184 840 236 Q 920 288 1000 236 Q 1080 184 1160 236 Q 1240 288 1320 236 L 1400 236" fill="none" stroke="#64748b" stroke-width="13" stroke-linecap="round" opacity="0.6"/>
            <path d="M 40 236 Q 120 184 200 236 Q 280 288 360 236 Q 440 184 520 236 Q 600 288 680 236 Q 760 184 840 236 Q 920 288 1000 236 Q 1080 184 1160 236 Q 1240 288 1320 236 L 1400 236" fill="none" stroke="#cbd5e1" stroke-width="4.5" stroke-linecap="round" stroke-dasharray="9,9" opacity="0.8"/>

            <!-- LEVEL 1 (Valley - Top edge at 236 touches road bottom) -->
            <g transform="translate(69, 236)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=1'">
            ...
            <!-- LEVEL 2 (Peak - Bottom edge at 184 touches road top) -->
            <g transform="translate(149, 130)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=2'">
            ...
            <!-- LEVEL 3 (Valley - Top edge at 236 touches road bottom) -->
            <g transform="translate(229, 236)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=3'">
            ...
            <!-- LEVEL 4 (Peak - Bottom edge at 184 touches road top) -->
            <g transform="translate(309, 130)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=4'">
            ...
            <!-- LEVEL 5 (Valley - Top edge at 236 touches road bottom) -->
            <g transform="translate(389, 236)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=5'">
            ...
            <!-- LEVEL 6 (Peak - Bottom edge at 184 touches road top) -->
            <g transform="translate(469, 130)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=6'">
            ...
            <!-- LEVEL 7 (Valley - Top edge at 236 touches road bottom) -->
            <g transform="translate(549, 236)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=7'">
            ...
            <!-- LEVEL 8 (Peak - Bottom edge at 184 touches road top) -->
            <g transform="translate(629, 130)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=8'">
            ...
            <!-- LEVEL 9 (Valley - Top edge at 236 touches road bottom) -->
            <g transform="translate(709, 236)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=9'">
            ...
            <!-- LEVEL 10 (Peak - Bottom edge at 184 touches road top) -->
            <g transform="translate(789, 130)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=10'">
            ...
            <!-- LEVEL 11 (Valley - Top edge at 236 touches road bottom) -->
            <g transform="translate(869, 236)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=11'">
            ...
            <!-- LEVEL 12 (Peak - Bottom edge at 184 touches road top) -->
            <g transform="translate(949, 130)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=12'">
            ...
            <!-- LEVEL 13 (Valley - Top edge at 236 touches road bottom) -->
            <g transform="translate(1029, 236)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=13'">
            ...
            <!-- LEVEL 14 (Peak - Bottom edge at 184 touches road top) -->
            <g transform="translate(1109, 130)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=14'">
            ...
            <!-- LEVEL 15 (Valley - Top edge at 236 touches road bottom) -->
            <g transform="translate(1189, 236)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=15'">
            ...
            <!-- LEVEL 16 (Peak - Bottom edge at 184 touches road top) -->
            <g transform="translate(1269, 130)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=16'">
            ...
            <g transform="translate(1360, 210)" style="cursor:pointer;" onclick="window.parent.location.href='?lvl=16'">
...
# =========================================================
    ...
    # ---------------------------------------------------------
    # LEVEL 14: PERSONAL LOCATION & 50 U.S. STATES
    # ---------------------------------------------------------
    elif lvl_id == "lvl_14":
        questions = [
            {"q": "What city do you live in?", "correct": "Covington", "opts": ["Atlanta", "Covington", "Savannah"], "hint": "Covington, GA!"},
            {"q": "How many states are in the United States?", "correct": "50", "opts": ["48", "50", "52"], "hint": "Fifty states!"},
    ...
    # ---------------------------------------------------------
        ...
        if current_step < len(questions):
            ...
            st.success("🎉 Level 15 Completed! Level 16 Unlocked!")
            if st.button("Next Level"):
                st.session_state.active_level_id = "lvl_16"
                st.rerun()

    # ---------------------------------------------------------
    # LEVEL 16: SEASONS, DAYS OF THE WEEK & MONTHS
    # ---------------------------------------------------------
    elif lvl_id == "lvl_16":
        questions = [
            {"q": "How many days are in a week?", "correct": "7", "opts": ["5", "7", "10"], "hint": "Sunday to Saturday!"},
            {"q": "How many months are in a year?", "correct": "12", "opts": ["10", "12", "4"], "hint": "From January to December!"},
            {"q": "Which season comes after winter with blooming flowers?", "correct": "Spring", "opts": ["Summer", "Spring", "Fall"], "hint": "Warming up and growing flowers!"}
        ]
        if current_step < len(questions):
            q = questions[current_step]
            speak(q["q"])
            ...
            for i, opt in enumerate(q["opts"]):
                with [c1, c2, c3][i]:
                    if st.button(f"👉 {opt}", key=f"l16_{current_step}_{opt}", use_container_width=True):
                        if opt == q["correct"]:
                            record_progress(lvl_id, True)
                            st.balloons()
                            speak("Correct!")
