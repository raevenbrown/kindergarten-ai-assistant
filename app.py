...
# =========================================================
# SCREEN 3: CANDY LAND ROAD MAP (GAP CLOSED, MAP CLICKABLE ONLY)
# =========================================================
    ...
    # FULL BLUE-BORDERED CONTAINER WITH GAP CLOSED (HEIGHT SET TO 440 SO ANIMALS SIT RIGHT AGAINST THE BOTTOM BORDER)
    road_map_html = f"""
    <div style="background:linear-gradient(135deg, #e0f2fe, #bae6fd); border:5px solid #0284c7; border-radius:36px; padding:25px 20px 25px 20px; box-shadow:0 16px 32px rgba(0,0,0,0.12); position:relative; margin:10px auto; width:100%; box-sizing:border-box;">
    ...
    """
    components.html(road_map_html, height=440)
